...
urlpatterns = [
    ...
    path(r'reset-password', views.reset, name="reset-password"),
    path(r'logout', views.user_logout, name="logout"),
    #path(r'profile', views.user_profile, name="profile"),
    #path(r'update-profile', views.UpdateUserProfileWizard.as_view([UserInfosForm, UserDocumentForm, UserLinkForm]), name="update-profile"),
