            ...
            <div class="col s12 m12 l4">
                <div class="card card-alert card-main">
                    ...
                    <div class="card-content card-highlight-title">
                        ...
                        <p>Montant: <b>${funding_request.amount}</b></p>
                        <div class="progress">
                    ...
                    <div class="card-action card-action-share">
                        ...
                        <div>
                            ...
                            <span class="right social-icone"><a href="#" title="facebook" class="btn-floating btn-small red"><i class="mdi-facebook"></i></a></span>
                            <span class="right social-icone"><a href="#" title="X" class="btn-floating btn-small red"><i class="material-icons">x</i></a></span>
...
$('#filterForm').submit(function(event) {
    ...
    $.ajax({
        url: apiUrl, // L'URL de la vue Django qui gère les filtres
        type: 'GET',
        data: formData,
        success: function(response) {
            $('#loader').hide();
